namespace FrontEnd.Services
{
    ...
    public class FinanceHttpClient : IFinanceHttpClient
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        private HttpClient _httpClient = new HttpClient();

        public FinanceHttpClient(IHttpContextAccessor httpContextAccessor)
        {
        ...
        private static string IdentityProvider =>
            ConfigurationManager.AppSettings["IdentityProvider"];
        ...
        //    // get the metadata
        //    var discoveryClient = new DiscoveryClient(IdentityProvider);
